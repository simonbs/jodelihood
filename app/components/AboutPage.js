...
var AboutPage = React.createClass({  
  render: function() {
    return (
      ...
      <p>The smartphone application <a href='http://jodel-app.com' target='_blank'>Jodel</a> lets users anonymously post short messages and photos that are visible to other nearby users. Jodelihood shows <Link to='/'>a map</Link> of all recent posts made by users that are near the visitor of this website.<br /><br />      
      ...
      <strong>The purpose of Jodelihood has never been to expose Jodel in any negative way.</strong> I am a user of the app. I like the app. I do, however, intend to examplify the consequences careless handling of sensitive data has.<br /><br />
